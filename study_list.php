...
<link rel="icon" type="image/png" href="assets/images/logoV.png">
<style>
...
<header class="app-header">
  <div class="header-brand">
    <img src="assets/images/logoV.png" alt="Logo" class="brand-logo-img">
          ...
          <?php foreach ($patients as $p): ?>
            <?php
              ...
              if (function_exists('makePatientShareToken')) {
                  ...
                  if ($base !== '') {
                      $longUrl = $base . '/external_viewer.php?share=' . urlencode($token);
              ...
              $whatsappJs = "(function(btn, e) {
                  ...
                  const text = ['Welcome to Ravco Polyclinic.', '', det, '', url, '', 'We wish you continued health and wellness.'].join('\\n');
