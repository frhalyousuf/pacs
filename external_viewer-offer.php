...
// Generate absolute URL for sharing
 ...
 $logoUrl = $protocol . $host . dirname($_SERVER['PHP_SELF']) . '/assets/images/logoO.png';
?>
<!doctype html>
<html lang="en">
<head>
...
<title>Arzheen Hospital</title>
<meta property="og:type" content="website">
<meta property="og:url" content="<?= htmlspecialchars($currentUrl) ?>">
<meta property="og:title" content="Arzheen Hospital">
<meta property="og:description" content="Patient Name: <?= htmlspecialchars($study['patient_name']) ?> | Patient ID: <?= htmlspecialchars($study['pid']) ?>. Welcome to Arzheen Hospital. We wish you continued health and wellness.">
<meta property="og:image" content="<?= htmlspecialchars($logoUrl) ?>">
<meta property="og:site_name" content="Arzheen Hospital">

<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="Arzheen Hospital">
<meta name="twitter:description" content="Patient Name: <?= htmlspecialchars($study['patient_name']) ?> | Patient ID: <?= htmlspecialchars($study['pid']) ?>. Welcome to Arzheen Hospital.">
...
<div id="pacs-splash-screen">
  ...
  <div class="pacs-loader-center">
    ...
    <div class="logo-wrap"><img id="pacs-splash-logo" src="assets/images/logoO.png" alt="Logo"></div>
  </div>
  ...
  <div class="report-modal-box">
    ...
    <div class="report-paper">
      <table class="report-print-table">
        ...
        <tfoot>
          <tr><td>
            <div class="report-footer">external_viewer-offer.php | Tel: +XXX-XXX-XXXX | Address Here</div>
          </td></tr>
        </tfoot>
      </table>
    </div>
...
function playWelcomeVoice() {
  if ('speechSynthesis' in window) {
    ...
    const utterance = new SpeechSynthesisUtterance("Welcome to Arzheen Hospital center");
    utterance.rate = 0.9;  
    utterance.pitch = 0.8; 
